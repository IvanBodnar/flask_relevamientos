...
'''
# Crea lista de horas empezando por espacio en blanco
HORA = [('', '')]
for hora in [(x, str(x)) for x in range(0, 24)]:
    HORA.append(hora)

# Crea lista de minutos empezando por espacio en blanco
MINUTOS = [('', '')]
for minuto in [(x, str(x)) for x in range(0, 60)]:
